import{_ as e}from"./MarkdownRenderer.vue_vue_type_script_setup_true_lang-C2ANVAvG.js";import{d as n,c as t,u as i,o as a}from"./index-CVtbX3b6.js";const s=`<style>
...
**Software Formal Verification Engineer** | *December 2024 – Present* | Budapest BME  
...
- **Key contributions:**
  - **Model Checking Portfolio Optimization** — enhancing portfolio efficiency by transferring partial results between algorithms such as CEGAR (Expl and Pred), BMC, KIND, and IMC, while introducing a novel stopping heuristic (*TDK 1st Prize [(View Paper)](https://aboutme.klevis.xyz/tdk.pdf), ongoing thesis work*).
...
**Full-Stack Engineer** | *January 2025 - Present (Maintenance Only)* | Germany Stuttgart Online and In-person during Summer
...
---
#### Education
| [Budapest University of Technology and Economics (BME)](https://www.bme.hu/en) | Computer Engineering BSc| 7th Sem (last) | GPA: 4.93/5.00 |
|:--------------------------------------------------------------------------|:---------------------|:--------|:----------------|
---
